...
namespace Onana_Hospital_Management_System
{
    class clsInsert
    {
       public string dbPath = @"Data Source=DESKTOP-LIB9TN5;Initial Catalog=dbOHMS;Integrated Security=True";
        ...
        public void InsertToDept(string name)
        {
            try
            {
                //string dbPath = @"Data Source=DESKTOP-LIB9TN5;Initial Catalog=dbOHMS;Integrated Security=True";
